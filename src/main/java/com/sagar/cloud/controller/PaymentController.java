...
public class PaymentController {
	...
	public String getPaymentSuccess(Model model, HttpSession session,RedirectAttributes redirectAttributes) {
		try {
	...
	public String getPaymentFailure(Model model, HttpSession session,RedirectAttributes redirectAttributes) {
		try {
	...
	public String getPaymentRequest(Model model, HttpSession session, HttpServletRequest request,
		...
		try {
			...
			if (!paymentMode.equalsIgnoreCase("Online")) {
				...
				redirectAttributes.addFlashAttribute("message", "Order has been placed successfully!");
	...
	public String getCCAvanueResponse(Model model, HttpServletRequest request, HttpSession session,RedirectAttributes redirectAttributes) {
		try {
