...
public class IndexController {
	...
	String getIndex(Model mv, @ModelAttribute("message") String message) {
		...
		if (message != null) {
			mv.addAttribute(Constant.MESSAGE, message + "");
		}
		return "/page-login";
	}

	@GetMapping(value = { "/page-error.html" })
	String getError(Model mv,HttpSession session) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
		mv.addAttribute("action", Action.LOGIN);
	...
	String getAdmin(Model mv, @ModelAttribute("message") String message,@RequestParam(name ="panelId",required = false) Integer panelId) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
		mv.addAttribute("action", Action.ADMIN);
		mv.addAttribute("userClickAdmin", true);
		mv.addAttribute("companyName", Constant.NAME);
		mv.addAttribute("panelId", panelId);
		if (message != null) {
			mv.addAttribute(Constant.MESSAGE, message + "");
		}
		return "/page-admin";
	...
	String getMainDashboard(Model mv,@RequestParam(name ="panelId",required = false) Integer panelId) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
	...
	String getAboutUs(Model mv,@RequestParam(name ="panelId",required = false) Integer panelId) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
	...
	String getContactUs(Model mv,@RequestParam(name ="panelId",required = false) Integer panelId) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
	...
	String getSignUp(Model mv, @ModelAttribute("message") String message,@RequestParam(name ="panelId",required = false) Integer panelId) {
		mv.addAttribute("title", Constant.TITLE);
		mv.addAttribute("NAME", Constant.NAME);
