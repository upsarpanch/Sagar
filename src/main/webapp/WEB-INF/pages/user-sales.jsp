          ...
          <div class="card">
            ...
            <br/>
              ...
              <form action="${action}" method="post" class="row g-3 needs-validation" novalidate>
                ...
                <div class="row mb-3">
                  <label for="totalSales" class="col-sm-2 col-form-label">Total Sales</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="totalSales" name="totalSales" placeholder="liter" required>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#disabledAnimation">Submit</button>
