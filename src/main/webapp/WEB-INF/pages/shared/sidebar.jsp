		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="components-nav" class="nav-content collapse "
					...
					<li><a href="${contextRoot}/admin/product.html"> <i
							class="bi bi-circle"></i><span>Add Product</span>
					</a></li>
					...
					<li><a href="${contextRoot}/admin/product-requirement.html">
							<i class="bi bi-circle"></i><span>Product Requirement</span>
					</a></li>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="tables-nav" class="nav-content collapse "
					...
					<%-- <li><a href="${contextRoot}/admin/sales-report.html"> <i
							class="bi bi-circle"></i><span>Report Details</span>
					</a></li> --%>
				</ul></li>
			<!-- End Tables Nav -->
	...
	<c:if test="${sessionScope.role==null}">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<%-- <li class="nav-item"><a class="nav-link collapsed"
				...
				href="${contextRoot}/dashboard.html"> <i
					class="bi bi-layout-text-window-reverse"></i><span>Home Page</span>
			</a> --%>
			<%-- 	<ul id="tables-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="${contextRoot}/dashboard.html"> <i
							class="bi bi-circle"></i><span>Dashboard</span>
					</a></li>
					<li><a href="${contextRoot}/about.html"> <i
							class="bi bi-circle"></i><span>About Us</span>
					</a></li>
					<li><a href="${contextRoot}/contact.html"> <i
							class="bi bi-circle"></i><span>Contact Us</span>
					</a></li>
			...
			<li class="nav-item"><a class="nav-link "
				href="${contextRoot}/about.html"> <i class="bi bi-grid"></i>
					<span>Home</span>
			</a></li>
			
			
			<li class="nav-item"><a class="nav-link "
				href="${contextRoot}/contact.html"> <i class="bi bi-grid"></i>
					<span>Contact Us</span>
			</a></li>
			

			<li class="nav-item"><a class="nav-link "
				href="${contextRoot}/page-login.html"> <i class="bi bi-grid"></i>
					<span>User Login</span>
			</a></li>

			<%-- <li class="nav-item"><a class="nav-link "
				href="${contextRoot}/page-register.html"> <i class="bi bi-grid"></i>
					<span>Register</span>
			</a></li> --%>

			<li class="nav-item"><a class="nav-link "
				href="${contextRoot}/page-admin.html"> <i class="bi bi-grid"></i>
					<span>Admin</span>
			</a></li>
...
<%-- 
 ...
 --%>
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="tables-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="${contextRoot}/customer/product_requirement_history.html"> <i
							class="bi bi-circle"></i><span>Product Requirement History</span>
					</a></li>
					<li><a href="${contextRoot}/customer/sales-history.html"> <i
							class="bi bi-circle"></i><span>Sales History</span>
					</a></li>
