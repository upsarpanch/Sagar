							...
							<table class="table datatable">
								...
								<tbody>
									<c:forEach var="product" items="${products}">
										<tr>
											<td>${product[0].firstName}</td>
											<td>${product[0].lastName}</td>
											<td>${product[0].email}</td>
											<td>${product[0].mobileNumber}</td>
											<td>${product[0].pinCode}</td>
											<td>${product[0].branch[0].branchName}</td>


											<td><a
												href="${window.contextRoot}/admin/${product[0].userId}/product-requirement-view.html"
