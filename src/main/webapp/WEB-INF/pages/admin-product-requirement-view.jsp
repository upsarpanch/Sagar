			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
								...
								<tbody>
									...
									<c:forEach var="product" items="${products}">
										<tr>
											...
											<td><a
												href="${window.contextRoot}/admin/${product.requirementId}/${userId}/product-requirement-view-accept.html"
						...
						<form
							action="${window.contextRoot}/admin/${userId}/product-requirement-view-accept-all.html"
							method="post">
